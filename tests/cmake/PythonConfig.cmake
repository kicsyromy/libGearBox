...
if (PYTHON_FOUND)
    ...
    if (PYTHONLIBS_FOUND)
        ...
        if ((NOT (${PYTHON_VERSION_MAJOR} LESS 3)) AND (NOT (${PYTHON_VERSION_MINOR} LESS 4)))
            ...
            message (WARNING "Found Python ${PYTHON_VERSION_MAJOR}.${PYTHON_VERSION_MINOR} but is older than the minimum supported version, consider upgrading to at least 3.5")
        endif ()
    endif()
endif ()
